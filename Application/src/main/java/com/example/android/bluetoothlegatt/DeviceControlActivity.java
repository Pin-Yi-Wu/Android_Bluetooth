...
public class DeviceControlActivity extends Activity {
    ...
    private EditText edittext_input_value;
    ...
    private String Match_Mac = "B8:27:EB:3E:1D:92";
//    98:01:A7:A8:2A:88
    //写数据
...
//                mnotyGattService = mBluetoothLeService.getSupportedGattServices(UUID.randomUUID());
//                characteristic = mnotyGattService.getCharacteristic(UUID.randomUUID());
                //读数据的服务和characteristic
//                readMnotyGattService = mBluetoothLeService.getSupportedGattServices(UUID.randomUUID());
//                readCharacteristic = readMnotyGattService.getCharacteristic(UUID.randomUUID());
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch(item.getItemId()) {
            case R.id.menu_connect:
                if(mDeviceAddress.equals(Match_Mac))
                    mBluetoothLeService.connect(mDeviceAddress);
                else
                    Toast.makeText(DeviceControlActivity.this,"not match",Toast.LENGTH_LONG).show();
                return true;
